...
dataset_path = 'E:\\TESI\\TESI_LAMBONI_VIVIANA\\DATASET_FINALE_BALANCED_SPLITTED_RANDOM_CORRECTED'
...
for em in emotions:
    ...
    for d in directs: 
        ...
        print("Fine pulizia...")
        analysed_path = directory_path + '\\' + em
