...
dataset_balanced_divided_cropped = 'E:\\TESI\\TESI_LAMBONI_VIVIANA\\DATASET_FINALE_BALANCED_SPLITTED_RANDOM_CORRECTED_CROPPED'
...
for d in directs:
    for em in emotions:
        entries = os.scandir(dataset_balanced_divided + '\\' + d + '\\' + em + '\\')
        for en in entries:
            if en.is_file():
                imagePath = dataset_balanced_divided + '\\' + d + '\\' + em + '\\' + en.name
